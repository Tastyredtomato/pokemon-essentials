...
# You don't have to give the Quest a color - :SUPERLIGHTBLUE in this example. It will default to White.
   ...
   Quest.new(6, "Trouble at Bell Lake", "Assist Ranger Cade at Bell Lake.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   Quest.new(7, "Trouble in Lumishore", "Assist Ranger Huxley at Lumishore City.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   Quest.new(8, "Berry Support", "Gather 3 ORAN BERRIES for the Pokémon Rangers.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   Quest.new(9, "Route 1 Invasion", "Defeat the Pokémon Invasion on Route 1.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   Quest.new(10, "Poké-Farm Pests", "Clear the Pokémon Pests on Route 3.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   Quest.new(11, "Pesky Gulls", "Defeat the agressive Pelipper in Lumishore City.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   Quest.new(12, "Reserve Guardian", "Defeat the poacher in the Polder Reserve.", "Pokémon Rangers", "NPC 30", "Ranger Outpost", :GREEN),
   ...
   Quest.new(15, "Milk Errand", "Buy MooMoo Milk and bring it to Mom.", "Mom", "NPC 28", "Poké-Farm", :BLUE),
   Quest.new(16, "Assistant Tutorials", "Complete all the assistant's tutorials in Route 1, Bell Town and Route 2, then return to the lab for a reward from the assistant.", "Pokémon Assistant", "trchar028", "Various Locations", :WHITE),
   Quest.new(17, "TUTORIAL: Wild Battles", "Listen to the explanation about wild pokémon battles and participate in the practice battle.", "Pokémon Assistant", "trchar028", "Various Locations", :WHITE),
   Quest.new(18, "TUTORIAL: Trainer Battles", "Listen to the explanation about Trainer Battles.", "Pokémon Assistant", "trchar028", "Various Locations", :WHITE),
   Quest.new(19, "TUTORIAL: Towns", "Listen to the explanation about towns.", "Pokémon Assistant", "trchar028", "Various Locations", :WHITE),
   Quest.new(20, "TUTORIAL: Caverns", "Listen to the explanation about caverns.", "Pokémon Assistant", "trchar028", "Various Locations", :WHITE),
   Quest.new(21, "TUTORIAL: PokéGear", "Listen to the explanation about the PokéGear.", "Pokémon Assistant", "trchar028", "Various Locations", :WHITE),
   Quest.new(22, "Urgent Delivery", "Bring the PokéMedicine to Nurse Joy in Hedge Point.", "Nurse Joy", "NPC 16", "The Great Dam", :BLUE),
   ...
   Quest.new(27, "Ranger Delivery: Milldam", "Bring the supplies to the Milldam Rangers.","Pokémon Rangers","NPC 30","Bell Town", :GREEN),
   Quest.new(28, "Ranger Delivery: Lumishore", "Bring the supplies to the Lumishore Rangers.","Pokémon Rangers","NPC 30","Bell Town", :GREEN),
   Quest.new(29, "Ranger Delivery: Tidal Town", "Bring the supplies to the Tidal Rangers.","Pokémon Rangers","NPC 30","Milldam", :GREEN),
