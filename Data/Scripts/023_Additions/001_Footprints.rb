...
#===============================================================================
#patched to work with follower pokemon by Tastyredtomato
#===============================================================================
...
class Footprint
  def initialize(event,position)
    ...
    return if $PokemonGlobal.bicycle && event!=$game_player && pbEventCommentInput(event,0,"Follower")
    return if $game_map.terrain_tag($game_player.x,$game_player.y)==12 && event!=$game_player && pbEventCommentInput(event,0,"Follower")
